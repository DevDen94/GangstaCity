   ...
   public void sec()
    ...
    public void Sit_in()
    {
        ...
        else
        {
            ...
            Rcc_Header_Camera.SetActive(false);
            ...
            Rcc_Header_Camera.GetComponent<RCC_Camera>().cameraTarget.playerVehicle = target_RccCar.gameObject.GetComponent<RCC_CarControllerV3>();
            Rcc_Header_Camera.SetActive(true);
