...
namespace PixelCrushers
{
    ...
    public class InputDeviceManager : MonoBehaviour
    {
        ...
        public void ForceCursor(bool visible)
        {
            ...
            ControlFreak2.CFCursor.lockState = visible ? CursorLockMode.None : CursorLockMode.Locked;
            m_lastMousePosition = GetMousePosition();
...
#else
            return ControlFreak2.CF2Input.GetKeyDown(keyCode);
#endif
        }
...
#else
            return ControlFreak2.CF2Input.anyKeyDown;
#endif
        }
        ...
        public static bool DefaultGetButtonDown(string buttonName)
        {
            try
            {
                ...
                return false;
#else
                return string.IsNullOrEmpty(buttonName) ? false : ControlFreak2.CF2Input.GetButtonDown(buttonName);
#endif
            }
        ...
        public static bool DefaultGetButtonUp(string buttonName)
        {
            try
            {
                ...
                return false;
#else
                return string.IsNullOrEmpty(buttonName) ? false : ControlFreak2.CF2Input.GetButtonUp(buttonName);
#endif
            }
            catch (System.ArgumentException) // Input button not in setup.
            {
        ...
        public static float DefaultGetAxis(string axisName)
        {
            try
            {
                ...
                return 0;
#else
                return string.IsNullOrEmpty(axisName) ? 0 : ControlFreak2.CF2Input.GetAxis(axisName);
#endif
            }
...
#else
            return ControlFreak2.CF2Input.GetMouseButtonDown(buttonNumber);
#endif
        }
