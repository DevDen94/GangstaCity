    ...
    public class UnityTextFieldUI : MonoBehaviour, ITextFieldUI
    {
        ...
        public void StartTextInput(string labelText, string text, int maxLength, AcceptedTextDelegate acceptedText)
        {
            ...
            if (textField != null)
            {
                ...
                textField.TakeFocus();
                ignoreFirstAccept = (acceptKey != KeyCode.None) && ControlFreak2.CF2Input.GetKeyDown(acceptKey);
                ignoreFirstCancel = (cancelKey != KeyCode.None) && ControlFreak2.CF2Input.GetKeyDown(cancelKey);
            }
