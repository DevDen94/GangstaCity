...
namespace SickscoreGames.ExampleScene
{
	...
	public class ExampleController : MonoBehaviour
	{
		...
		void FixedUpdate ()
		{
			...
			if (isGrounded) {
				// directional input
				Vector3 targetVelocity = new Vector3 (ControlFreak2.CF2Input.GetAxis ("Horizontal"), 0f, ControlFreak2.CF2Input.GetAxis ("Vertical"));
				float moveSpeed = (ControlFreak2.CF2Input.GetKey (KeyCode.LeftShift)) ? runSpeed : walkSpeed;
