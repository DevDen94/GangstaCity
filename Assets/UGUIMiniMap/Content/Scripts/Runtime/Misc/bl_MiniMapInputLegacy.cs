        ...
        public override bool IsInputDown(MiniMapInput key)
        {
            ...
            switch (key)
            {
                case MiniMapInput.ZoomIn:
                    return ControlFreak2.CF2Input.GetKeyDown(zoomInKey);
                case MiniMapInput.ZoomOut:
                    return ControlFreak2.CF2Input.GetKeyDown(zoomOutKey);
                case MiniMapInput.ScreenMode:
                    return ControlFreak2.CF2Input.GetKeyDown(screenModeKey);
                default:
                    return false;
            }
#else
