    ...
    public class ETFXMouseOrbit : MonoBehaviour
    {
        ...
        private void Update()
        {
            if(target)
            {
                ...
                {
                    velocityX += xSpeed * ControlFreak2.CF2Input.GetAxis("Mouse X") * distance * 0.02f;
                ...
                distance = Mathf.Clamp(distance - ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") * 15, distanceMin, distanceMax);
            }
        }
